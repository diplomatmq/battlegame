...
function _drawKnightPreview(ctx, C, _s) {
    ...
    ctx.fillStyle = grad;
    ctx.beginPath();
    ctx.roundRect(-15, -62, 30, 44, 12);
    ctx.fill();
    // Chest plate
    ctx.fillStyle = "rgba(255,255,255,0.15)";
    ctx.beginPath();
    ctx.roundRect(-10, -58, 20, 28, 8);
    ctx.fill();
    // Legs (Rounded)
    ctx.fillStyle = "#2a1b38";
    ctx.beginPath();
    ctx.roundRect(-14, -22, 12, 26, 6);
    ctx.fill();
    ctx.beginPath();
    ctx.roundRect(2, -22, 12, 26, 6);
    ctx.fill();
    // Helmet
    ctx.fillStyle = grad;
    ctx.beginPath();
    ctx.roundRect(-15, -96, 30, 30, 15);
    ctx.fill();
    // Face
    ctx.fillStyle = "#f0c88a";
    ctx.beginPath();
    ctx.roundRect(-10, -84, 20, 14, 4);
    ctx.fill();
    // Eyes
    ctx.fillStyle = "#fff";
    ctx.fillRect(-5, -81, 4, 4);
    ctx.fillRect(3, -81, 4, 4);
    ctx.fillStyle = "#1e3a8a";
    ctx.fillRect(-3, -80, 2, 2);
    ctx.fillRect(5, -80, 2, 2);
    // Plume
    ...
    ctx.fillRect(18, -48, 6, 16); // handle
    ctx.fillStyle = "#d8d8e8";
    ctx.beginPath();
    ctx.roundRect(16, -86, 10, 40, 5);
    ctx.fill();
    ctx.fillStyle = "#cc2200";
    ctx.beginPath();
    ctx.ellipse(-22, -45, 12, 18, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.strokeStyle = "#ffcc00";
    ctx.lineWidth = 2;
    ctx.stroke();
}
function _drawKillerPreview(ctx, C, gt, _s) {
    // Shadow
...
function _drawMagePreview(ctx, C, gt, _s) {
    ...
    ctx.beginPath();
    ctx.roundRect(-8, -20, 16, 4, 2);
    ctx.fill();
    ctx.shadowBlur = 0;
    // Shoulder pads
    ctx.fillStyle = C;
    ctx.beginPath();
    ctx.arc(-16, -58, 7, 0, Math.PI, true);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(16, -58, 7, 0, Math.PI, true);
    ctx.fill();
    ...
    ctx.fillStyle = "#f0c88a";
    ctx.beginPath();
    ctx.roundRect(-10, -90, 20, 22, 10);
    ctx.fill();
    // Hair
    ctx.fillStyle = "#e8c030";
    ctx.beginPath();
    ctx.roundRect(-12, -94, 24, 14, 6);
    ctx.fill();
    // Eyes
    ctx.fillStyle = "#fff";
    ctx.beginPath();
    ctx.ellipse(-4, -84, 3, 4, 0, 0, Math.PI * 2);
    ctx.ellipse(4, -84, 3, 4, 0, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = "#2055ff";
    ctx.beginPath();
    ctx.arc(-3, -84, 1.5, 0, Math.PI * 2);
    ctx.arc(5, -84, 1.5, 0, Math.PI * 2);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.arc(-23.5, -110, 8, 0, Math.PI * 2);
    ctx.fill();
    ctx.shadowBlur = 0;
}
function _drawTrollPreview(ctx, C, _s) {
    ctx.fillStyle = "rgba(0,0,0,0.4)";
    ctx.beginPath();
    ctx.ellipse(0, 4, 40, 12, 0, 0, Math.PI * 2);
    ctx.fill();
    // Body (Massive Round)
    const grad = ctx.createLinearGradient(-30, -80, 30, -20);
    grad.addColorStop(0, C);
    grad.addColorStop(1, "#1a3311");
    ctx.fillStyle = grad;
    ctx.beginPath();
    ctx.roundRect(-30, -80, 60, 56, 20);
    ctx.fill();
    // Legs (Stocky)
    ctx.fillStyle = "#2d4a1a";
    ctx.beginPath();
    ctx.roundRect(-22, -30, 18, 30, 5);
    ctx.fill();
    ctx.beginPath();
    ctx.roundRect(4, -30, 18, 30, 5);
    ctx.fill();
    // Arms (Huge)
    ctx.fillStyle = grad;
    ctx.beginPath();
    ctx.roundRect(-42, -74, 18, 46, 10);
    ctx.fill();
    ctx.beginPath();
    ctx.roundRect(24, -74, 18, 46, 10);
    ctx.fill();
    // Head
    ctx.fillStyle = grad;
    ctx.beginPath();
    ctx.roundRect(-22, -115, 44, 42, 18);
    ctx.fill();
    // Eyes
    ctx.fillStyle = "#fff";
    ctx.beginPath();
    ctx.arc(-10, -96, 5, 0, Math.PI * 2);
    ctx.arc(10, -96, 5, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = "#cc0000";
    ctx.beginPath();
    ctx.arc(-9, -96, 2, 0, Math.PI * 2);
    ctx.arc(11, -96, 2, 0, Math.PI * 2);
    ctx.fill();
    // Tusks
    ctx.fillStyle = "#fffde0";
    ctx.beginPath();
    ctx.arc(-15, -80, 4, Math.PI, 0, true);
    ctx.fill();
    ctx.beginPath();
    ctx.arc(15, -80, 4, Math.PI, 0, true);
    ctx.fill();
    ...
    ctx.beginPath();
    ctx.roundRect(35, -100, 7, 80, 2);
    ctx.fill();
    ctx.fillStyle = "#8a8aaa";
    ctx.beginPath();
    ctx.ellipse(55, -80, 15, 25, 0.2, 0, Math.PI * 2);
    ctx.fill();
}
function _drawNecroPreview(ctx, C, gt, _s) {
    ...
    ctx.fillStyle = "#111";
    ctx.beginPath();
    ctx.roundRect(-15, -86, 30, 24, 12);
    ctx.fill();
    // Face shadow
    ctx.fillStyle = "#000";
    ctx.beginPath();
    ctx.roundRect(-8, -80, 16, 14, 6);
    ctx.fill();
    // Glowing eyes
    ctx.shadowBlur = 15;
    ctx.shadowColor = C;
    ...
    ctx.beginPath();
    ctx.roundRect(-24, -90, 4, 80, 2);
    ctx.fill();
    // Staff skull
    ctx.fillStyle = "#ddd";
    ctx.beginPath();
    ctx.roundRect(-28, -100, 12, 12, 4);
    ctx.fill();
    // Magical aura
    ctx.shadowBlur = 15;
    ctx.shadowColor = C;
    ctx.fillStyle = C;
    ctx.beginPath();
    ctx.arc(-22, -106, 7 + Math.sin(gt * 0.1) * 2, 0, Math.PI * 2);
    ctx.fill();
    ctx.shadowBlur = 0;
}
function _drawBerserkerPreview(ctx, C, gt, _s) {
    // Shadow
    ctx.fillStyle = "rgba(0,0,0,0.3)";
    ctx.beginPath();
    ...
    ctx.beginPath();
    ctx.roundRect(-18, -60, 36, 36 + breathe, 12);
    ctx.fill();
    // Pants
    ctx.fillStyle = "#3a1a10";
    ctx.beginPath();
    ctx.roundRect(-20, -28 - breathe, 40, 12, 5);
    ctx.fill();
    // Legs
    ctx.fillStyle = "#4a2a1a";
    ctx.beginPath();
    ctx.roundRect(-16, -24, 12, 24, 4);
    ctx.fill();
    ctx.beginPath();
    ctx.roundRect(4, -24, 12, 24, 4);
    ctx.fill();
    // Head
    ctx.fillStyle = "#e8a070";
    ctx.beginPath();
    ctx.roundRect(-10, -78, 20, 20, 8);
    ctx.fill();
    // Hair/Beard
    ctx.fillStyle = C;
    ctx.beginPath();
    ...
    ctx.fill();
    ctx.beginPath();
    ctx.roundRect(-12, -70, 24, 10, 4);
    ctx.fill();
    // Enraged Eyes
    ctx.fillStyle = "#fff";
    ctx.beginPath();
    ctx.arc(-4, -72, 3, 0, Math.PI * 2);
    ctx.arc(4, -72, 3, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = "#000";
    ctx.beginPath();
    ctx.arc(-4, -72, 1, 0, Math.PI * 2);
    ctx.arc(4, -72, 1, 0, Math.PI * 2);
    ctx.fill();
    // Axes
    ctx.fillStyle = "#4a2a1a";
    ctx.beginPath();
    ctx.roundRect(-30, -70, 4, 40, 2);
    ctx.fill();
    ctx.fillStyle = "#aab";
    ctx.beginPath();
    ctx.ellipse(-35, -60, 8, 12, 0.4, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = "#4a2a1a";
    ctx.beginPath();
    ctx.roundRect(26, -70, 4, 40, 2);
    ctx.fill();
    ctx.fillStyle = "#aab";
    ctx.beginPath();
    ctx.ellipse(31, -60, 8, 12, -0.4, 0, Math.PI * 2);
    ctx.fill();
}
export class Fighter {
    ...
    drawKnight(ctx, _gt, flash, leg, atk) {
        ...
        ctx.beginPath();
        ctx.roundRect(-13, -22, 11, 24 - leg, 5);
        ctx.fill();
        // Cape
        ctx.globalAlpha = 0.7;
        ...
        ctx.beginPath();
        ctx.roundRect(-16, -62, 32, 44, 12);
        ctx.fill();
        // Chest plate detail
        if (!flash) {
            ctx.fillStyle = "rgba(255,255,255,0.1)";
            ctx.beginPath();
            ctx.roundRect(-10, -56, 20, 30, 8);
            ctx.fill();
        }
        // Shoulder pads
        if (!flash) {
        ...
        if (!flash) {
            ctx.fillStyle = "#f0c88a";
            ctx.beginPath();
            ctx.roundRect(-9, -82, 18, 18, 4);
            ctx.fill();
        }
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(-12, -90, 24, 16, 12);
        ctx.fill();
        if (!flash) {
            // eyes
            ctx.fillStyle = "#fff";
            ctx.fillRect(-5, -78, 5, 4);
            ctx.fillRect(3, -78, 5, 4);
            ctx.fillStyle = "#1e3a8a";
            ctx.fillRect(-2, -77, 2, 3);
            ctx.fillRect(6, -77, 2, 3);
            // visor
            ctx.fillStyle = "rgba(0,0,0,0.2)";
            ctx.fillRect(-11, -85, 22, 5);
        }
        // Front arm + shield
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(-24, -60, 12, 32, 6);
        ctx.fill();
        if (!flash) {
            ctx.fillStyle = "#cc2200";
            ctx.beginPath();
            ctx.ellipse(-26, -45, 12, 18, 0, 0, Math.PI * 2);
            ctx.fill();
            ctx.strokeStyle = "#ffcc00";
            ctx.lineWidth = 2;
            ctx.stroke();
        ...
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(14, -62, 12, 28, 6);
        ctx.fill();
        // Front leg
        ctx.fillStyle = flash ? "#fff" : "#4a3060";
        ctx.beginPath();
        ctx.roundRect(2, -22, 11, 24 + leg, 5);
        ctx.fill();
        // Weapon
        ...
        if (wv === "axe")
            ...
            this.drawSword(ctx, atk);
    }
    drawKiller(ctx, _gt, flash, leg, atk) {
        const C = this.color;
        // Lean body (Rounded)
        const grad = ctx.createLinearGradient(-12, -60, 12, 0);
        ...
        ctx.beginPath();
        ctx.roundRect(-10, -15, 8, 15 - leg, 4);
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(2, -15, 8, 15 + leg, 4);
        ctx.fill();
        // Arms (Dual wield)
        this.fill(ctx, flash, "#222");
        ctx.beginPath();
        ctx.roundRect(-20, -55, 8, 25, 4);
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(12, -55, 8, 25, 4);
        ctx.fill();
        // Daggers
        this.drawDagger(ctx, -18, -35, -0.5, atk);
        this.drawDagger(ctx, 18, -35, 0.5, atk);
    }
    drawDagger(ctx, x, y, rot, atk) {
        ctx.save();
        ctx.translate(x, y);
        ctx.rotate(atk ? rot * 2.5 : rot);
        ctx.fillStyle = "#333";
        ctx.fillRect(-2, 0, 4, 8); // handle
        ctx.fillStyle = "#ccc";
        ctx.beginPath();
        ctx.moveTo(-3, 0);
        ctx.lineTo(0, -15);
    ...
    drawMage(ctx, gt, flash, leg, atk) {
        ...
        ctx.beginPath();
        ctx.roundRect(-14, -60, 10, 62, 5);
        ctx.fill();
        // Robe main (Organic path)
        const grad = ctx.createLinearGradient(-12, -60, 12, 0);
        grad.addColorStop(0, C);
        grad.addColorStop(1, "#1a0840");
        this.fill(ctx, flash, grad);
        ctx.beginPath();
        ctx.moveTo(-12, -60);
        ctx.lineTo(14, -60);
        ctx.lineTo(16, 0);
        ...
        ctx.fill();
        ctx.beginPath();
        ctx.arc(12, -60, 6, 0, Math.PI * 2);
        ctx.fill();
        // Head (Rounded)
        if (!flash) {
            ctx.fillStyle = "#f0c88a";
            ctx.beginPath();
            ctx.roundRect(-9, -88, 18, 20, 8);
            ctx.fill();
        }
        // Hair (Organic)
        if (!flash) {
            ctx.fillStyle = "#e8c030";
            ctx.beginPath();
            ctx.arc(0, -90, 10, Math.PI, 0);
            ctx.fill();
            ctx.beginPath();
            ctx.roundRect(-12, -88, 6, 14, 3);
            ctx.fill();
        }
        ...
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(-20, -62, 9, 30, 4);
        ctx.fill();
        // Staff (Natural wood)
        if (!flash) {
            ctx.fillStyle = "#6b3e23";
            ctx.beginPath();
            ctx.roundRect(-26, -100, 5, 80, 2);
            ctx.fill();
        }
        // Orb glow
        if (!flash) {
    ...
    drawTroll(ctx, _gt, flash, leg, atk) {
        ...
        ctx.beginPath();
        ctx.roundRect(-18, -28, 16, 28 - leg, 8);
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(4, -28, 16, 28 + leg, 8);
        ctx.fill();
        ...
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(-18, -105, 36, 35, 15);
        ctx.fill();
        if (!flash) {
            // Tusks (Curved)
            ctx.fillStyle = "#fffde0";
            ctx.beginPath();
            ctx.quadraticCurveTo(-20, -70, -25, -85);
            ctx.lineTo(-15, -75);
            ctx.fill();
            ctx.beginPath();
            ctx.quadraticCurveTo(20, -70, 25, -85);
            ...
            ctx.fillStyle = "#cc0000";
            ctx.beginPath();
            ctx.arc(-7, -92, 2, 0, Math.PI * 2);
            ctx.arc(9, -92, 2, 0, Math.PI * 2);
            ctx.fill();
        }
        // Arms (Huge/Rounded)
        this.fill(ctx, flash, C);
        ctx.beginPath();
        ctx.roundRect(-40, -72, 18, 44, 9);
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(22, -72, 18, 44, 9);
        ctx.fill();
        // Axe
        this.drawAxe(ctx, atk);
    }
    // ────────────────────────────────────────────────────────── NECROMANCER
    drawNecro(ctx, gt, flash, leg, atk) {
        const C = this.color;
        ...
        if (!flash) {
            ...
            ctx.beginPath();
            ctx.ellipse(-14, 0, 4, 15 + Math.sin(gt * 0.2) * 5, 0, 0, Math.PI * 2);
            ctx.fill();
            ctx.beginPath();
            ctx.ellipse(14, 0, 4, 15 + Math.cos(gt * 0.2) * 5, 0, 0, Math.PI * 2);
            ctx.fill();
            ctx.globalAlpha = 1;
        }
        ...
        ctx.fillStyle = flash ? "#fff" : "#111";
        ctx.beginPath();
        ctx.roundRect(-15, -90, 30, 26, 15);
        ctx.fill();
        if (!flash) {
            ctx.fillStyle = "#000";
            ctx.beginPath();
            ctx.roundRect(-10, -82, 20, 16, 8);
            ctx.fill(); // Face shadow
            // Glowing angular eyes
            ctx.shadowBlur = 15;
            ctx.shadowColor = C;
            ctx.fillStyle = C;
            ctx.beginPath();
            ctx.arc(-4, -76, 2.5, 0, Math.PI * 2);
            ctx.arc(4, -76, 2.5, 0, Math.PI * 2);
            ctx.fill();
            ctx.shadowBlur = 0;
        }
        ...
        if (!flash) {
            ctx.fillStyle = "#3a2a40";
            ctx.beginPath();
            ctx.roundRect(18, -95, 4, 85, 2);
            ctx.fill();
            // Skull (Rounded)
            ctx.fillStyle = "#ddd";
            ctx.beginPath();
            ctx.roundRect(14, -105, 12, 12, 4);
            ctx.fill();
            // Glow
            ctx.shadowBlur = 25;
            ctx.shadowColor = C;
            ctx.fillStyle = C;
            ctx.beginPath();
            ctx.arc(20, -110, 7 + (atk ? 5 : 0), 0, Math.PI * 2);
            ctx.fill();
            ctx.shadowBlur = 0;
        }
    }
    ...
    drawBerserker(ctx, _gt, flash, leg, atk) {
        ...
        ctx.beginPath();
        ctx.roundRect(-18, -24, 14, 24 - leg, 6);
        ctx.fill();
        ctx.beginPath();
        ctx.roundRect(6, -24, 14, 24 + leg, 6);
        ctx.fill();
        // Muscular Body (Organic)
        this.fill(ctx, flash, "#e8a070");
        ctx.beginPath();
        ctx.roundRect(-22, -65, 44, 42, 15);
        ctx.fill();
        if (!flash) {
            // Tattoos (Rounded)
            ctx.fillStyle = C;
            ...
            ctx.fillStyle = "#3a1a10";
            ctx.beginPath();
            ctx.roundRect(-24, -30, 48, 14, 5);
            ctx.fill();
            ctx.fillStyle = "#8a8a9a";
            ctx.beginPath();
            ctx.roundRect(-8, -32, 16, 8, 3);
            ctx.fill(); // Belt
        }
        // Head (Rounded)
        this.fill(ctx, flash, "#e8a070");
        ctx.beginPath();
        ctx.roundRect(-12, -85, 24, 22, 10);
        ctx.fill();
        if (!flash) {
            // Hair/Beard (Organic)
            ctx.fillStyle = C;
            ctx.beginPath();
            ctx.arc(0, -85, 14, Math.PI, 0);
            ctx.fill();
            ctx.beginPath();
            ctx.roundRect(-14, -72, 28, 12, 5);
            ctx.fill(); // Beard
            // Eyes (Angry dots)
            ctx.fillStyle = "#fff";
            ctx.beginPath();
            ctx.arc(-5, -78, 3, 0, Math.PI * 2);
            ctx.arc(5, -78, 3, 0, Math.PI * 2);
            ctx.fill();
            ctx.fillStyle = "#000";
            ctx.beginPath();
            ctx.arc(-5, -78, 1, 0, Math.PI * 2);
            ctx.arc(5, -78, 1, 0, Math.PI * 2);
            ctx.fill();
        }
        // Rage aura
